...
<body>
    <div class="container" id="login-container">
        ...
        <form id="login-form" action="<?php echo site_url("admin/do-login") ?>" method="post">
            <div class="form-group">
                <label for="adminUsername">Username :</label>
                <input type="text" id="adminUsername" name="adminUsername"
                required placeholder="Ketikkan Password Anda">
            </div>
            <div class="form-group">
                <label for="adminPassword">Password :</label>
                <input type="password" id="adminPassword" name="adminPassword"
                 required placeholder="Ketikkan Username Anda">
            </div>
            <div class="form-group">
