...
<body>
    <div class="container" id="login-container">
        <div class="header">
            <img src="<?php echo site_url("assets/gambar/tut_wuri_handayani.png") ?>"
            alt="Logo SMA" width="24" height="24">
            <h1>SIDISIPLIN</h1>
        </div>
        ...
        <form id="login-form">
            <div class="form-group">
                ...
                <input type="email" id="adminUsername" required placeholder="Ketikkan Password Anda">
            </div>
            <div class="form-group">
                <label for="adminPassword">Password :</label>
                <input type="password" id="adminPassword" required placeholder="Ketikkan Username Anda">
            </div>
            <div class="form-group">
